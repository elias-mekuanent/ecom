...
urlpatterns = [
  ...
  path("update-address/<int:pk>", views.update.as_view(), name="update"),
  ...
  path('password_change/',auth_view.PasswordChangeView.as_view(template_name="passwordchange.html",form_class=MyPasswordChangeForm, success_url='Passwordchangedone'),name='passwordchange'),
